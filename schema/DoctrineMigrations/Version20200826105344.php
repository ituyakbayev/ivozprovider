...
class Version20200826105344 extends LoggableMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE Companies ADD maxDailyUsageNotificationTemplateId INT UNSIGNED DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE Companies DROP maxDailyUsageNotificationTemplateId');
